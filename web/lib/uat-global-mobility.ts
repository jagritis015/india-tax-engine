...
export const MOBILITY_CASE_FIXTURES: MobilityCase[] = [
  ...
  },
  {
    ...
    unsupportedCalculations: [
      "Germany monetary tax engine is not verified for this UAT.",
    ],
    lastUpdated: updatedAt,
  },
  {
    ...
    unsupportedCalculations: [
      "No DTAA calculation path is configured. Double-taxation exposure requires specialist review.",
    ],
    lastUpdated: updatedAt,
  },
  {
...
export const OBLIGATION_FIXTURES: ObligationRecord[] = [
  ...
  },
  {
    ...
    severityWhenOpen: "BLOCKER",
    reason:
      "No DTAA path is configured; cancellation cannot clear specialist review in Phase 1.",
    evidenceReferences: [],
    ruleReference: "NON-DTAA-FAIL-CLOSED-V1",
    provenanceReference: "Corridor reference data",
    revision: 3,
    updatedAt,
  },
  {
